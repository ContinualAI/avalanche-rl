...
class BaseStrategy:
    ...
    **Evaluation loop**
    ...
    def __init__(self, model: Module, optimizer: Optimizer,
                 ...
                 evaluator=BaseLogger(), eval_every=-1):
        """ Init.
    ...
    def train(self, experiences: Union[CLExperience, Sequence[CLExperience]],
    ...
    def train_exp(self, experience: CLExperience, eval_streams=None, **kwargs):
    ...
    @torch.no_grad()
    def eval(self,
             exp_list: Union[CLExperience, Sequence[CLExperience]],
             **kwargs):
        """
